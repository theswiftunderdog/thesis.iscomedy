...
$sql = "SELECT order_id, order_name, full_name, date_created, quantity, price, status FROM orders WHERE status = 'Pending' AND DATE(date_created) = :current_date";
$stmt = $conn->prepare($sql);
...
<body>
    ...
    <div class="main-content">   
        <div class="admO-header"><h1>Today's Orders</h1></div>
        <?php if (empty($orders)): ?>
